...
public:
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr point_cloud_ = std::make_shared<pcl::PointCloud<pcl::PointXYZ>>();
        // 初始化最小最大点
    pcl::PointXYZ bbMin  = pcl::PointXYZ(std::numeric_limits<float>::max(),std::numeric_limits<float>::max(),std::numeric_limits<float>::max());
    pcl::PointXYZ bbMax  = pcl::PointXYZ(std::numeric_limits<float>::lowest(),std::numeric_limits<float>::lowest(),std::numeric_limits<float>::lowest());
private:
